...
<div class="container">
    <main id="content" role="main" class="middle-align">
        <header>
            <h1 class="entry-title"><?php /* translators: %s: search term */ printf( esc_html__( 'Results For: %s','vw-hosting-services'), esc_html( get_search_query() ) ); ?></h1> 
        </header>
        <?php
            ...
            if($vw_hosting_services_theme_lay == 'Left Sidebar'){ ?>
                <div class="row">
                    ...
                    <div id="our-services" class="services col-lg-8 col-md-8">
                        <?php if( get_theme_mod( 'vw_hosting_services_blog_post_pagination_position','bottom') == 'top' || get_theme_mod( 'vw_hosting_services_blog_post_pagination_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'vw_hosting_services_blog_pagination_hide_show',true) == 1) { ?>
                              <div class="navigation">
                                <?php vw_hosting_services_blog_posts_pagination(); ?>
                        ...
                        ?>
                        <?php if( get_theme_mod( 'vw_hosting_services_blog_post_pagination_position','bottom') == 'bottom' || get_theme_mod( 'vw_hosting_services_blog_post_pagination_position','bottom') == 'both') { ?>
                            <?php if( get_theme_mod( 'vw_hosting_services_blog_pagination_hide_show',true) == 1) { ?>
                              <div class="navigation">
                                <?php vw_hosting_services_blog_posts_pagination(); ?>
                                  <div class="clearfix"></div>
            ...
            <?php }else if($vw_hosting_services_theme_lay == 'Three Columns'){ ?>
                <div class="row">
            ...
            <?php }else if($vw_hosting_services_theme_lay == 'Four Columns'){ ?>
                <div class="row">
                    <div class="col-lg-3 col-md-3" id="sidebar"><?php dynamic_sidebar('sidebar-1');?></div>
