...
if ( ! class_exists( 'VW_Hosting_Services_WPTT_WebFont_Loader' ) ) {
	/**
	 * Download webfonts locally.
	 */
	class VW_Hosting_Services_WPTT_WebFont_Loader {
...
if ( ! function_exists( 'wptt_get_webfont_styles' ) ) {
	...
	function wptt_get_webfont_styles( $url, $format = 'woff2' ) {
		$font = new VW_Hosting_Services_WPTT_WebFont_Loader( $url );
