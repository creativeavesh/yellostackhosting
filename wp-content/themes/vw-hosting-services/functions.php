...
function vw_hosting_services_activation_notice() {
	...
	echo '<span class="demo-btn"><a href="'. esc_url( 'https://www.vwthemes.net/vw-hosting-services/' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'VIEW DEMO', 'vw-hosting-services' ) .'</a></span>';
	echo '<span class="upgrade-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/hosting-wordpress-theme' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'UPGRADE PRO', 'vw-hosting-services' ) .'</a></span>';
	echo '<span class="bundle-btn"><a href="'. esc_url( 'https://www.vwthemes.com/products/wp-theme-bundle' ) .'" class="button button-primary" target=_blank>'. esc_html__( 'THEME BUNDLE', 'vw-hosting-services' ) .'</a></span>';
	echo '</div>';
}
...
function vw_hosting_services_widgets_init() {
	...
	register_sidebar(array(
		'name'          => __('Sidebar 3', 'vw-hosting-services'),
		'description'   => __('Appears on Blog Page sidebar', 'vw-hosting-services'),
		'id'            => 'sidebar-3',
...
define('VW_HOSTING_SERVICES_BUY_NOW',__('https://www.vwthemes.com/products/hosting-wordpress-theme','vw-hosting-services'));
...
define('VW_HOSTING_SERVICES_CREDIT',__('https://www.vwthemes.com/products/free-web-hosting-wordpress-theme','vw-hosting-services'));
define('VW_HOSTING_SERVICES_THEME_BUNDLE_BUY_NOW',__('https://www.vwthemes.com/products/wp-theme-bundle','vw-hosting-services'));
define('VW_HOSTING_SERVICES_THEME_BUNDLE_DOC',__('https://preview.vwthemesdemo.com/docs/theme-bundle/','vw-hosting-services'));
...
function vw_hosting_services_sanitize_float( $input ) {
...
add_filter('loop_shop_columns', 'vw_hosting_services_loop_columns');
	...
	function vw_hosting_services_loop_columns() {
		return get_theme_mod( 'vw_hosting_services_products_per_row', 3 );
		// 3 products per row
	}
}

//Change number of products that are displayed per page (shop page)
add_filter( 'loop_shop_per_page', 'vw_hosting_services_products_per_page' );
function vw_hosting_services_products_per_page( $cols ) {
  	return  get_theme_mod( 'vw_hosting_services_products_per_page',9);
}
